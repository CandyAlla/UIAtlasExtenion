...
//    }
	...
	// static public Color ParseColor (UnicodeText text, int offset) { return NGUIText.ParseColor24(text, offset); }
	//
	// [System.Obsolete("Use NGUIText.StripSymbols instead")]
	// static public UnicodeText StripSymbols (UnicodeText text) { return NGUIText.StripSymbols(text); }
