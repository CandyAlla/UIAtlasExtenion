...
public class UIWidget : UIRect
{
    ...
    //public bool TimelineChangeWidth = false;
    //public bool TimelineChangeHeight = false;
    //public bool TimelineChangeColor = false;
    //public bool TimelineChangeAlpha = false;
    //public bool TimelineChangeLocalPos = false;
    //public bool TimelineChangeLocalRot = false;
    //public void SetDataFromTimeline(NGUITimeline.WidgetChangeableData data)
    //{
    //    if (TimelineChangeWidth) { this.width = (int)data.Width; }
    //    if (TimelineChangeHeight) { this.height = (int)data.Height; }
    //    if (TimelineChangeColor) { this.color = data.Color; }
    //    if (TimelineChangeAlpha) { this.alpha = data.Alpha; }
    //    if (TimelineChangeLocalPos) { this.transform.localPosition = data.LocalPosition; }
    //    if (TimelineChangeLocalRot) { this.transform.localEulerAngles = data.LocalEulerAngles; }
    //}
}
