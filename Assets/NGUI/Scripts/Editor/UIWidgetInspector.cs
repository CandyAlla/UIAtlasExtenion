...
public class UIWidgetInspector : UIRectEditor
{
	...
	static public void DrawInspectorProperties (SerializedObject so, UIWidget w, bool drawColor)
	{
        ...
        //if (NGUIEditorTools.DrawHeader("Timeline Controls"))
        //{
        //    NGUIEditorTools.BeginContents();
        //    NGUIEditorTools.DrawProperty("Width", so, "TimelineChangeWidth");
        //    NGUIEditorTools.DrawProperty("Height", so, "TimelineChangeHeight");
        //    NGUIEditorTools.DrawProperty("Color", so, "TimelineChangeColor");
        //    NGUIEditorTools.DrawProperty("Alpha", so, "TimelineChangeAlpha");
        //    NGUIEditorTools.DrawProperty("LocalPos", so, "TimelineChangeLocalPos");
        //    NGUIEditorTools.DrawProperty("LocalRot", so, "TimelineChangeLocalRot");
        //    NGUIEditorTools.EndContents();
        //}
    }
